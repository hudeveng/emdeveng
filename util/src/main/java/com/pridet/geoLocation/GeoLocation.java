package com.pridet.geoLocation;
...
public class GeoLocation {
	...
	public double distanceTo(GeoLocation location, double radius) {
		...
		return Double.parseDouble(df.format(Math.acos(Math.sin(radLat) * Math.sin(location.radLat) +
	...
	public static void main(String[] args ){
		...
		GeoLocation geoLocation = GeoLocation.fromDegrees(13.069520, 77.582284);
		GeoLocation geoLocation1 = GeoLocation.fromDegrees(12.943243, 77.691906);
		System.out.println(geoLocation.distanceTo(geoLocation1, 6371));
	}
	}